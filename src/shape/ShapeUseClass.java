...
public class ShapeUseClass extends BaseShape
{
	public ShapeUseClass(DisplayGraphics canvas, int x, int y, int id, BaseShape parent)
	{
	...
	public void paintOnCanvas(Graphics2D g2d)
	{
		...
		g2d.drawString(name, x+20, y+(int)(height/2.0f));
